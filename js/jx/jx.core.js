...
;(function(tn){
    ...
    try{
        ...
        if(typeof Jx === "undefined" || (Jx.mark && Jx.mark === mark)){
             ...
             * @example
             * //范例：
             * Jx().$package("codesRoom.lin", function(J){
             *     var $ = J.dom.id,
             *     $D = J.dom,
             *     $E = J.event,
             *     $H = J.http;
            ...
            Jx.prototype = {
                 ...
                 *
                 * @example
                 * //创建一个名字为codesRoom.lin的package包：
                 * Jx().$package("codesRoom.lin", function(J){
                 *     //这时上下文对象this指向window对象下的codesRoom.lin对象
                 *     alert("Hello world! This is " + this);
                 * };
                 *
                 *
                 ...
                 * Jx().$package(function(J){
                 *     // 输出undefined
                 *     J.out(J.checkPackage("codesRoom.lin"));
                 * };
                 *
                 *
                 * @example
                 * //创建一个名字为codesRoom.lin的package包：
                 * Jx().$package("codesRoom.lin", function(J){
                 *     //这时上下文对象this指向window下的codesRoom.lin对象
                 *     alert("Hello world! This is " + this);
                 * };
                 *
                 * Jx().$package(function(J){
                 *     // J.checkPackage("codesRoom.lin")结果返回的将是codesRoom.lin的引用
                 *     var lin = J.checkPackage("codesRoom.lin");
                 *     if(lin){
                 *         J.out("codesRoom.lin包已加载...");
                 *     }
                 * };
                 *
                 */
